...
export function API_HOST() {
    return 'http://api.xianjinxia.com';
} 

export default {

    checkReg: API_HOST + '/member/check_reg',
    sendMsg: API_HOST + '/member/send_msg',
    login: API_HOST + '/member/login',
    register: API_HOST + '/member/reg',
